...
def run(general_params,
    ...
    elif a2c_params['env_id'] in ['PongNoFrameskip-v4', 'EnduroNoFrameskip-v4', 'BreakoutNoFrameskip-v4', 'BowlingNoFrameskip-v4']:
...
def start_policy_training(cluster_dict, make_reward_predictor, gen_segments,
    ...
    if env_id in ['MovingDotNoFrameskip-v0', 'MovingDot-v0']:
        policy_fn = MlpPolicy
    elif env_id in ['PongNoFrameskip-v4', 'EnduroNoFrameskip-v4','BreakoutNoFrameskip-v4', 'BowlingNoFrameskip-v4']:
        policy_fn = CnnPolicy
    else:
